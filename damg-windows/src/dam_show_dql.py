...
class ModuleManage(object):
    ...
    def obtain_object(self):
        ...
        if _MANUAL_STAT == 'yes':
            print('Collecting information about dql ...')

        # Get the dml information.
        for usr in self.oracle_user:
            oracle_user = usr
            record_path = self.record_home + oracle_user + '.dql'
